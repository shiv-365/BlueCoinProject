...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_transaction_service__ = __webpack_require__(283);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__providers_transaction_service__ = __webpack_require__(283);
=======
...
var TransactionService = /** @class */ (function () {
    function TransactionService(http) {
        this.http = http;
        this.API = 'http://localhost:8080/api/v1';
        this.BLOCK_API = this.API + '/transactions';
    }
    TransactionService.prototype.createTransaction = function (transaction) {
        return this.http.post(this.BLOCK_API, transaction);
    };
